...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', '--set-program', default='hsetroot -fill {0}', help='the tool used for setting the composited background image. Default is "Esetroot {0}", where {0} will be substituted with the path of the composited background image', nargs=1)
